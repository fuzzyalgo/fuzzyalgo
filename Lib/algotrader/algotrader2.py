        ...
        for sym in symbols:
            ...
            if True == self.gUseRates:
                ...
                if self.mt5_init():
                    ...
                    self.gDt['dt_count'] = self.KDtCount
                    self.gDt['dt_to'] = dt_from
                    self.gDt['dt_from'] = self.gDt['dt_to']  - timedelta(seconds=(60)) # seconds=max_seconds*self.gDt['dt_count']))
            ...
            if 0 < len_dfana_prev:
                ...
                if   (0 == dfana_prev.sigbs) and (0 != npa[0]['sigpcm']) and (npa[0]['c0'] > npa[0]['pob']):
                    ...
                    npa[0]['sigbs']     = mplus
                    npa[0]['optp']      = dfc0 + mplus*dfpcmax_start*points*pfactp
                    npa[0]['opp']       = dfc0
                    npa[0]['opsl']      = dfc0 + minus*dfpcmax_start*points*pfacsl
                    npa[0]['diff']      = 0
                    ...
                    dfpcmax_start = int( abs( npa[0]['pos'] - npa[0]['pop'] ) / points )
                    npa[0]['sigbs']     = minus
                    npa[0]['optp']      = dfc0 + minus*dfpcmax_start*points*pfactp
                    npa[0]['opp']       = dfc0
                    npa[0]['opsl']      = dfc0 + mplus*dfpcmax_start*points*pfacsl
                    npa[0]['diff']      = 0
                    npa[0]['sum']       = dfana_prev['sum']
