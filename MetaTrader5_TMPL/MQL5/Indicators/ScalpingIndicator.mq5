...
const string gIndicatorName = "ScalpingIndicator";
            ...
            const int &Spread[])
{
   ...
   double l_high_96 = 0;*/
    ...
    {
        //l_high_96 = High[iHighestMQL4(Symbol(),Period(), MODE_HIGH, intensity, li_104)];
        //l_low_88 = Low[iLowestMQL4(Symbol(),Period(), MODE_LOW, intensity, li_104)];
        double l_high_96 = High[ArrayMaximum(High, li_104, intensity)];
        double l_low_88  = Low [ArrayMinimum(Low,  li_104, intensity)];
