...
def MainFunction( _sym = 'EURUSD', _TicksPerPeriod  = 0, _TimeDelta = 0 ):
    ...
    gTitleStr = _sprintf("%s %d %s ( %s - %s )",\
      gH.gACCOUNT, _TicksPerPeriod, _sym, str(topen), str(tclose) )
...
# TODO to enable this the following code has to be uncommented at around line no 786
#    # TODO sort me out FLIP
#    #_npa = _npa[(len(_npa)-_TicksPerPeriod):]   <- this code has to be uncommented at around line 786 
#    #_npa = np.flip(_npa)
