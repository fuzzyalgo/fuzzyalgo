...
def Term_MainFunction( _sym, _npa, _timeObj ):
...
# END def Term_MainFunction( _sym = 'EURUSD', _TicksPerPeriod  = 0, _TimeDelta = 0 ):
...
print( gStrH )
print()
Term_MainFunction( cSym, _npa1, gTime)
Term_MainFunction( cSym, _npa2, gTime)
print()
print( gStrH )
print()
